...
class Assinatura(db.Model):
    ...
    plano = db.Column(db.String(50), nullable=False, default="Essencial")
    valor_mensal = db.Column(db.Float, nullable=False, default=299.90)
    ...
    renovacao_automatica = db.Column(db.Boolean, nullable=False, default=True)
